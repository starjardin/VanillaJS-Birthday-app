...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"node_modules/date-fns/esm/_lib/requiredArgs/index.js":[function(require,module,exports) {
"use strict";
...
const fetchPeople = async () => {
  _axios.default.get(endPoint).then(response => {
    ...
    const deletePersonPupup = async idOfPeopleToDelete => {
      ...
      text.textContent = "Are you sure you want to delete ".concat(peopleToDelete.firstName, " ").concat(peopleToDelete.lastName);
      const buttoncontainer = document.createElement("div");
      buttoncontainer.appendChild(yesBtn);
      buttoncontainer.appendChild(noBtn); //add both "yes" and "no" button to the container

      btnPopup.appendChild(text);
      btnPopup.appendChild(buttoncontainer); //add the container to the DOM
...
fetchPeople();
},{"axios":"node_modules/axios/index.js","date-fns/format":"node_modules/date-fns/esm/format/index.js"}],"../../AppData/Roaming/npm/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
